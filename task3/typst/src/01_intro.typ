...
Система LaTeX, созданная Лесли Лэмпортом на основе TeX Дональда Кнута @knuth1984texbook, на протяжении десятилетий остаётся стандартом де-факто в академической среде~--- особенно в математике, физике и информатике @latex-project. Её мощные инструменты для набора математических формул и широкая экосистема пакетов делают её незаменимым инструментом для учёных и инженеров.

Вместе с тем LaTeX обладает рядом существенных недостатков: сложный и многословный синтаксис, медленная компиляция для больших документов, нередко трудно интерпретируемые сообщения об ошибках. В 2023~году была представлена система Typst @typst-github~--- современная альтернатива, разработанная с учётом упомянутых ограничений.
...
Структура работы:
+ в разделе 1 приводится обзор обеих систем
+ в разделе 2 выполняется сравнительный анализ по нескольким критериям;
+ в разделе 3 рассматриваются практические примеры кода.
